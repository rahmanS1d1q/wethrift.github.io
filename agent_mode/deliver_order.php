...
<div class="container mt-3">
    ...
    <h5 class="w-50 m-auto my-4"> Your Earning:
        <?php echo "Rp.$order_agentPayment"; ?>
    </h5>
...
if (isset ($_POST['submit_deliver'])) {
    ...
    $trans_statement = "$current_date^ You earned Rp$order_agentPayment for successfully delivering order $order_id^ $new_balance1^ $withdrawn^ $new_total1";
