...
<head>
    ...
    <title>Customer Login - WeThrift</title>
    ...
    <div class="container">
        <div class="login-container">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <button type="submit" class="btn btn-login" name="user_login">
                ...
                <div class="text-center">
                    <p class="mb-0">
                        ...
                        <a href="customer_registration.php" class="register-link">Register now</a>
                    </p>
                </div>
            </form>
        </div>
