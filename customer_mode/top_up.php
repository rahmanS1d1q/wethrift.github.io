...
<div class="container mt-3">
    ...
    <h4 class="w-50 m-auto my-4">Current Balance: Rp.<?php echo "$balance";?></h4>
...
if (isset ($_POST['edit_amount'])) {
    ...
    if ($added_amount == '') {
        ...
        if ($result_query) {
            echo "<script>alert('Wallet Balance has been updated successfully. Updated balance = Rp.$new_amount'); window.location.href = 'profile_page.php?customer_id=" . $cust_id . "&top_up';</script>";
        }
    }
}
?>